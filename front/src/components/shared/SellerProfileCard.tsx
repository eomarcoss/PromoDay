  ...
  return (
    <>
      ...
      <div className="w-full max-w-4xl flex flex-col gap-5">
        ...
        <Card className="relative overflow-hidden bg-white border border-slate-200/80 rounded-3xl shadow-sm hover:shadow-md transition-all duration-300">

          {/* Top Banner Accent Sutil */}
          <div className="h-28 w-full bg-gradient-to-r from-primary/15 via-primary/5 to-transparent relative border-b border-slate-100">
            <div className="absolute inset-0 bg-[radial-gradient(#111827_1px,transparent_1px)] [background-size:16px_16px] opacity-[0.04]" />

            {/* Tag de Conta de Vendedor Verificada */}
            <div className="absolute top-4 right-4 flex items-center gap-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-white/90 backdrop-blur-md border border-slate-200 text-[#111827] shadow-xs">
          ...
          <CardContent className="px-6 pb-6 pt-0 sm:px-8 sm:pb-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 -mt-12 mb-6">
              ...
              <div className="flex items-end gap-4">
                <div className="relative group">
                  <div className="w-24 h-24 rounded-3xl bg-white border-4 border-white shadow-lg flex items-center justify-center overflow-hidden shrink-0 ring-1 ring-slate-200">
                    {sellerData.avatarUrl ? (
                      ...
                      <div className="w-full h-full bg-slate-50 flex items-center justify-center">
                        <span className="text-[#111827] font-black text-2xl uppercase tracking-wider">
                  ...
                  <span
                    className={`absolute bottom-1 right-1 w-4 h-4 rounded-full border-2 border-white ${isStoreOpenNow ? "bg-emerald-500" : "bg-slate-300"
                      }`}
                ...
                <div className="pb-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      className={`inline-flex items-center gap-1.5 text-xs font-medium ${isStoreOpenNow ? "text-emerald-600" : "text-slate-500"
                        }`}
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${isStoreOpenNow ? "bg-emerald-500 animate-pulse" : "bg-slate-300"
                          }`}
                      />
              ...
              <button
                ...
                className="w-full sm:w-auto h-10 px-4 bg-primary hover:bg-primary/90 text-[#111827] font-semibold text-xs rounded-full transition-all duration-300 flex items-center justify-center gap-2 shadow-sm hover:shadow active:scale-[0.98] cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-4 border-t border-slate-100">
              ...
              {/* E-mail */}
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-slate-50/70 border border-slate-100 hover:bg-slate-50 transition-all duration-300">
                <div className="w-9 h-9 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 shrink-0 shadow-xs">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <span className="text-xs font-medium text-[#111827] truncate mt-0.5">
                    {email}
                  </span>
                </div>
              </div>
              ...
              {/* Endereço */}
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-slate-50/70 border border-slate-100 hover:bg-slate-50 transition-all duration-300 md:col-span-2">
                <div className="w-9 h-9 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 shrink-0 shadow-xs">
              ...
              <div className="flex flex-col p-3.5 rounded-2xl bg-slate-50/70 border border-slate-100 md:col-span-2 transition-all">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-9 h-9 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-primary shrink-0 shadow-xs">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <span className="text-xs font-semibold text-[#111827] truncate mt-0.5">
                ...
                {showFullSchedule && (
                  <div className="mt-3 pt-3 border-t border-slate-200 grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs animate-in fade-in duration-200">
                    {DAY_KEYS_ORDER.map((dayKey) => {
                      const daySchedule = currentHoursParsed[dayKey];
                      const isToday = JS_DAY_MAP[new Date().getDay()] === dayKey;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* Card: Total de Promoções — acento PRIMARY */}
          <div className="group relative overflow-hidden bg-white border border-slate-200/80 rounded-3xl p-5 shadow-sm hover:shadow-md transition-all duration-300 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-2xl font-black text-[#111827] tabular-nums tracking-tight mt-0.5">
                  {isLoadingMetrics ? (
          ...
          {/* Card: Total de Vendas — acento FOREGROUND */}
          <div className="group relative overflow-hidden bg-white border border-slate-200/80 rounded-3xl p-5 shadow-sm hover:shadow-md transition-all duration-300 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-[#111827]/5 text-[#111827] border border-[#111827]/10 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
            ...
            <span className="text-[11px] font-medium text-white bg-[#111827] px-2.5 py-1 rounded-full">
              Vendas
            </span>
          </div>
        </div>
      ...
      {isEditing && (
        ...
        >
          <div
            className="bg-white text-card-foreground border border-slate-200 w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]"
          ...
          >
            ...
            <div className="px-6 pt-5 pb-3 border-b border-slate-100 shrink-0">
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  ...
                  className="p-2 rounded-xl text-slate-500 hover:text-[#111827] hover:bg-slate-100 transition-all duration-300 disabled:opacity-50 cursor-pointer"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-xl border border-slate-100">
                <button
                  type="button"
            ...
            <form onSubmit={handleSave} className="flex flex-col flex-1 overflow-hidden">
                  ...
                  <div className="space-y-4 animate-in fade-in duration-150">
                    ...
                    <div className="flex flex-col items-center justify-center pb-2">
                      <div className="relative group cursor-pointer">
                        <div className="w-20 h-20 bg-slate-100 rounded-2xl flex items-center justify-center overflow-hidden border-2 border-slate-200 shadow-sm">
                          {editForm.avatarUrl ? (
                            <img
                            ...
                            <span className="text-[#111827] font-bold text-xl uppercase">
                              {editForm.name.substring(0, 2)}
                            </span>
                          )}
                        </div>
                        <label className="absolute inset-0 bg-white/80 backdrop-blur-xs rounded-2xl flex items-center justify-center text-[#111827] opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-slate-50 border border-slate-200 focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/20 rounded-xl py-2.5 px-3 text-sm font-medium text-[#111827] outline-none transition-all disabled:opacity-60 capitalize cursor-pointer"
                          required
                        >
                          <option value="" disabled>Selecione...</option>
                          <option value="supermercado">Supermercado & Mercados</option>
                          <option value="farmacia">Farmácia & Drogarias</option>
                          <option value="padaria">Padaria & Confeitarias</option>
                          <option value="hortifruti">Hortifrúti & Feira</option>
                          <option value="restaurante">Restaurantes & Lanchonetes</option>
                    ...
                    <div className="space-y-2">
                      {DAY_KEYS_ORDER.map((dia) => {
                        ...
                        return (
                          <div
                            key={dia}
                            className="flex flex-col sm:flex-row sm:items-center justify-between p-2.5 rounded-xl border border-slate-100 bg-slate-50/60 hover:bg-slate-100/70 transition-all duration-300 gap-2"
                          >
                            <label
                            ...
                            >
                              <input
                                ...
                                onChange={(e) =>
                                  handleHoursChange(dia, "aberto", e.target.checked)
                                }
                                className="w-4 h-4 accent-primary rounded cursor-pointer"
                              />
                              <span
                                className={`text-xs font-semibold ${infoDia.aberto ? "text-[#111827]" : "text-slate-400"
                                  }`}
                              >
                                {DAY_LABELS[dia]}
                              </span>
                            ...
                            {infoDia.aberto ? (
                              <div className="flex items-center gap-1.5 self-end sm:self-auto">
                                <input
                                  ...
                                  onChange={(e) =>
                                    handleHoursChange(dia, "inicio", e.target.value)
                                  }
                                  className="bg-white text-[#111827] text-xs font-semibold rounded-lg px-2 py-1 border border-slate-200 focus:outline-none focus:ring-1 focus:ring-primary"
                                />
                              ...
                              <span className="text-xs font-medium text-slate-400 self-end sm:self-auto pr-2">
                                Fechado
                              </span>
                            )}
                          </div>
              ...
              <div className="p-4 px-6 border-t border-slate-100 bg-slate-50/60 flex items-center gap-3 shrink-0">
                <button
                  type="button"
                  disabled={isSubmitting}
                  onClick={() => setIsEditing(false)}
                  className="flex-1 py-2.5 px-4 bg-slate-100 hover:bg-slate-200 text-[#111827] font-semibold text-xs rounded-xl transition-all disabled:opacity-50 cursor-pointer"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="flex-1 py-2.5 px-4 bg-primary hover:bg-primary/90 text-[#111827] font-semibold text-xs rounded-full transition-all duration-300 flex items-center justify-center gap-2 shadow-sm disabled:opacity-50 cursor-pointer"
                >
                  {isSubmitting ? (
                    <>
